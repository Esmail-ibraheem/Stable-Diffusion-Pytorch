...
class DenoisingDiffusionProbabilisticModelSampler:
    ...
    def _get_variance(self, timestep: int) -> torch.Tensor:
        ...
        variance = (1 - alphas_product_t) / (1 - alphas_product_t_previous) * current_beta_t
    ...
    def step(self, 
        ...
        predicate_original_sample = (latents - beta_t ** (0.5) * model_output) / alphas_product_t
        predicate_original_sample_coeff = (alphas_product_t_previous ** (0.5) * current_beta_t) / beta_t
        predicate_current_sample_coeff = current_alphas_product_t ** (0.5) * beta_t_previous / beta_t
